 ...
 *  @generated
 */
package com.tunyun.product.ebc.web.idl;
...
public class DataServer {
  ...
  public interface Iface {
    ...
    /**
     * 客户端向服务端发送数据请求，主要用于发送json格式数据
     * @param model  模块名称
     * @param item  功能名称
     * @param inputStr  输入参数，格式为json
     * @return 数据返回json格式
     * 
     * @param model
     * @param item
     * @param inputStr
     */
    public String execute(String model, String item, String inputStr) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void execute(String model, String item, String inputStr, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public String execute(String model, String item, String inputStr) throws org.apache.thrift.TException
    {
      send_execute(model, item, inputStr);
      return recv_execute();
    }

    public void send_execute(String model, String item, String inputStr) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void execute(String model, String item, String inputStr, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      execute_call method_call = new execute_call(model, item, inputStr, resultHandler, this, ___protocolFactory, ___transport);
    ...
    public static class execute_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public execute_call(String model, String item, String inputStr, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class execute<I extends Iface> extends org.apache.thrift.ProcessFunction<I, execute_args> {
      ...
      public execute_result getResult(I iface, execute_args args) throws org.apache.thrift.TException {
        execute_result result = new execute_result();
        result.success = iface.execute(args.model, args.item, args.inputStr);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class execute<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, execute_args, String> {
      ...
      public void start(I iface, execute_args args, org.apache.thrift.async.AsyncMethodCallback<String> resultHandler) throws TException {
        iface.execute(args.model, args.item, args.inputStr,resultHandler);
      }
    }
  ...
  public static class execute_args implements org.apache.thrift.TBase<execute_args, execute_args._Fields>, java.io.Serializable, Cloneable, Comparable<execute_args>   {
    ...
    private static final org.apache.thrift.protocol.TField INPUT_STR_FIELD_DESC = new org.apache.thrift.protocol.TField("inputStr", org.apache.thrift.protocol.TType.STRING, (short)3);
    ...
    public String inputStr; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      MODEL((short)1, "model"),
      ITEM((short)2, "item"),
      INPUT_STR((short)3, "inputStr");
    ...
    public execute_args setModel(String model) {
      this.model = model;
      return this;
    }
    ...
    public execute_args setItem(String item) {
      this.item = item;
      return this;
    }
    ...
    public execute_args setInputStr(String inputStr) {
      this.inputStr = inputStr;
      return this;
    }
    ...
    public int hashCode() {
      ...
      boolean present_inputStr = true && (isSetInputStr());
      list.add(present_inputStr);
      if (present_inputStr)
        list.add(inputStr);
    ...
    public int compareTo(execute_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetInputStr()).compareTo(other.isSetInputStr());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetInputStr()) {
